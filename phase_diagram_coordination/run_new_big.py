...
from main_new import get_stationary_state_sample
import constants as const
from config_big import config_values
...
if __name__ == '__main__':
    ...
    av_degree = int(sys.argv[5])
    log.info(f'T={T}, S={S}, k={av_degree}, dir_name={dir_name}')

    config = dict(config_values, update_str_type=update_str_type, T=T, S=S, av_degree=av_degree)
