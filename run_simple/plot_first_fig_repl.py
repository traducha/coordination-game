...
def plot_res(str_type=const.REPLICATOR, N=1000, res_dir='res_repl_n1000'):
    ...
    traj_files = {
        const.REPLICATOR: [
            'trajectory_n1000_k3_bNone_RNone_PNone_TNone_SNone_pay1_up3_loo5_len10_num50000_che1_sam500.json',
            'trajectory_n1000_k8_bNone_RNone_PNone_TNone_SNone_pay1_up3_loo5_len10_num50000_che1_sam500.json',
            'trajectory_n1000_k20_bNone_RNone_PNone_TNone_SNone_pay1_up3_loo5_len10_num50000_che1_sam500.json',
        ]
    }
    ...
    plot_name = f"simple_repl_traj.pdf"
