...
def plot_res():
    ...
    for i, k in enumerate([2, 7, 10, 20, 22, 33, 40]):
        file_name = f'trajectory_n1000_k{k}_bNone_RNone_PNone_TNone_SNone_pay1_up2_loo5_len10_num50000_che1_sam500.json'
    ...
    plot_name = f"simple_imit_traj_only.pdf"
