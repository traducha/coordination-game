...
def plot_res(str_type=const.BEST_RESPONSE, N=1000, res_dir='res_best_n1000'):
        ...
        for i, value in enumerate(res['left_fraction']):
            if k > 10:
                if random.random() < 0.04:
                    plt.plot(k, value, marker='o', markerfacecolor='none', alpha=0.7, color=const.GREEN)
            else:
    ...
    traj_files = {
        const.BEST_RESPONSE: [
            'trajectory_n1000_k3_bNone_RNone_PNone_TNone_SNone_pay1_up4_loo5_len10_num50000_che1_sam500.json',
            'trajectory_n1000_k8_bNone_RNone_PNone_TNone_SNone_pay1_up4_loo5_len10_num50000_che1_sam500.json',
            'trajectory_n1000_k20_bNone_RNone_PNone_TNone_SNone_pay1_up4_loo5_len10_num50000_che1_sam500.json',
        ]
    }
    ...
    plot_name = f"simple_best_traj.png"
