...
if __name__ == '__main__':
    ...
    script = f'run_over_nov{k}.py'
    results_dir = f"res_{rules[update_str_type]}_k{k}_sgap{S1-S2}"
    ...
    for i, node_overlap in enumerate(node_overlap_list):
        ...
        command = f'run -t 20:00 -o {out_file} -e {er_file} {py_path} {script} {node_overlap} {update_str_type} {results_dir} {T1} {S1} {T2} {S2}'
        os.system(command)
