...
time_std = []
for T in T_list:
    config = dict(config_values, update_str_type=const.UNCOND_IMITATION, T=T)
    res, _ = read_stationary_generic(config, directory='imitation_res5000')
